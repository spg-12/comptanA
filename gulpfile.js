...
function doJson() {
    return src('./origin/json/*.*')
        .pipe(dest('./publish/json/'))

}

function refresh() {
    return watch("./origin", series(doClean, [doCss, doHTML, doJS, doResource, doJson]))
}

module.exports.webserver = webserver;
module.exports.doResource = doResource;
module.exports.a = series(doClean, [doCss, doHTML, doJS, doResource, doJson], webServer);
